...
if env['PLATFORM'] == 'darwin': #macos
    ...
    LINK='{} {} -framework OpenGL -framework Cocoa -framework IOKit -L./lib/{}'.format(CXX, '-fsanitize=address' if SANITIZE_MEM == 1 else '', BLD)
