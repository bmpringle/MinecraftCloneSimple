...
CCFLAGS='-static -O{} -I {} -I {} -I {} -I {} -I {} -I {} -I {} {} -D _USE_MATH_DEFINES -Wall -g -std=c++2a -DGLEW_STATIC'.format(OPT, "./glm/", './', './include/', GLFW_INCLUDE, GLEW_INCLUDE, LIBNOISEINC, NOISE_DIR, '-DDBG' if DBG==1 else '')
